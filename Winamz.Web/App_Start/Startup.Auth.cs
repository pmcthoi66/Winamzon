...
using Winamz.Service;
using Winamz.Web.Infrastructure.Core;

[assembly: OwinStartup(typeof(Winamz.Web.App_Start.Startup))]

namespace Winamz.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(WinamzDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<WinamzDbContext>());
